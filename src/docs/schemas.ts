 ...
 *         attribute:
 *           type: string
 *           description: ObjectId reference to parent Attribute
 ...
 *         hex:
 *           type: string
 *           description: Optional hex color code for color swatches
 *           example: "#FF0000"
 *         status:
 *           type: string
 *           enum: [active, inactive]
 ...
 *         attributeset:
 *           type: string
 *           description: ObjectId reference to an AttributeSet
 *           example: "64f1e2b3c9e77b001f8e4abc"
 *         values:
 *           type: array
 ...
 *         id:
 *           type: string
 *           example: "64f1e2b3c9e77b001f8e4bbb"
 *         productId:
 *           type: string
 *           description: ObjectId reference to parent Product
 ...
 *         salePrice:
 *           type: number
 *           description: Strike-through / original price (mapped from comparePrice on input)
 *           example: 20.00
 *         comparePrice:
 *           type: number
 *           description: Compare at price (must be >= price)
 *           example: 20.00
 *         totalStock:
 *           type: number
 *           example: 200
 ...
 *           items:
 *             type: string
 *           example: ["https://images.example.com/shirt.jpg"]
 *         sizeChart:
 *           type: string
 *           description: URL or base64 data URI of size chart
 *           example: "https://images.example.com/sizechart.jpg"
 *         selectedCollection:
 *           type: array
 ...
 *             customReturnWindow:
 *               type: number
 *               description: Days; overrides store setting when useGlobalConfig is false
 *         averageRating:
 *           type: number
 *           example: 4.5
 *         totalReviews:
 ...
 *         description:
 *           type: string
 *           example: "Best deals of the summer season."
 *         image:
 *           type: string
 *           example: "https://images.example.com/summer-sale.jpg"
 *         collectionType:
 *           type: string
 *           enum: [manual, smart]
 *           example: manual
 ...
 *         parentCollection:
 *           type: string
 *           description: ObjectId of parent collection (for nested collections)
 *           example: "64f1e2b3c9e77b001f8e4eee"
 *         childCollection:
 *           type: array
 ...
 *           description: Used for smart collections
 ...
 *         metaDescription:
 *           type: string
 *           example: "Shop our best summer deals."
 *         metaKeywords:
 *           type: string
 *         createdAt:
 *           type: string
 ...
 *             message:
 *               type: string
 *               example: "price should be less than compare at price"
 *             details:
 *               type: array
 *               items:
 *                 type: object
